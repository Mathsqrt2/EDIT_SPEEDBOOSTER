class EffectInstance {
    ...
    drawEffectValues = (origin, property) => {
        if (property.type == "alert") {
            ...
            const switchBox = this.nItem(origin, "div");
            ...
            if (property.min != undefined && property.max != undefined) {
                ...
                const rangeInputName = this.nItem(rangeLabelBox, ["p", `${property.name}:`], "rangeInputName");
                this.rangeInputValue = this.nItem(rangeLabelBox, ["p", property.value], "rangeInputValue");
                const rangeContent = this.nItem(box, "div", "rangeContent");
                const rangeMinValue = this.nItem(rangeContent, ["p", `${property.min} min`], "rangeScale");
                ...
                rangeInput.step = 0.5;
                const rangeMaxValue = this.nItem(rangeContent, ["p", `${property.max} max`], "rangeScale");
