class EffectInstance {
    ...
    createEffectBar = () => {
        ...
        const effectShowHide = this.nItem(effectHeader,["input","button","show"],"showHideEffectButton");
        const effectContent = this.nItem(effectBody, "div", ["effecConent", "hidden"]);
        const confirmButton = this.nItem(effectContent, ["input", "button", "confirm"], "confirmButton");
    }
    appendEffectContent = () => {
    }
